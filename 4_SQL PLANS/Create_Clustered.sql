USE LibrarySystem_NONCLUSTERED;

CREATE TABLE [publishing] (
  [publishing_id]	INT iDENTITY (1, 1) NOT NULL UNIQUE,
...
CREATE TABLE [department] (
  [department_id]	INT iDENTITY (1, 1) NOT NULL UNIQUE,
...
CREATE TABLE [book_edition] (
  [book_edition_id] INT iDENTITY (1, 1) NOT NULL UNIQUE,
...
CREATE TABLE [reader] (
  [reader_id]		INT iDENTITY (1, 1) NOT NULL UNIQUE,
...
CREATE TABLE [issued_book] (
  [issued_book_id]	INT iDENTITY (1, 1) NOT NULL UNIQUE,
  [book_id]			INT NOT NULL FOREIGN KEY REFERENCES book(book_id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE [expired_book] (
  [expired_book_id] INT iDENTITY (1, 1) NOT NULL UNIQUE,
...
CREATE TABLE [fine_status] (
  [status_id]		INT iDENTITY (1, 1) NOT NULL UNIQUE,
  [status_name]		VARCHAR(20) NOT NULL
);


CREATE TABLE [decom_book] (
  [decom_book_id]	INT iDENTITY (1, 1) NOT NULL UNIQUE,
...
CREATE TABLE [fine] (
  [fine_id]			INT iDENTITY (1, 1) NOT NULL UNIQUE,
